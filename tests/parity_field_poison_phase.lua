...
-- The fixture overworld needs only these headless rendering/field defaults.
...
-- The ROM-free fixture names its Water starter analogue FIXMON_C.
Game.save.party = { Pokemon.new(Data, "FIXMON_C", 12) }

Game.stack:push(OW, "FIX_TOWN", 5, 6, "down")
...
reheal()
Game.save.poisonSteps = 2
ow:setMap("FIX_TOWN", 5, 6, "down", { via = "warp" })
...
reheal()
Game.save.poisonSteps = 2
ow:setMap("FIX_ROUTE", 9, 33, "up", { seamless = true, keepMusic = true })
